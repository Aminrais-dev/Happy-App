...
// CartData2 is an autogenerated mock type for the DataInterface type
type CartData2 struct {
	mock.Mock
}

// CheckCommunity provides a mock function with given fields: prodid
func (_m *CartData2) CheckCommunity(prodid int) (int, string, error) {
...
func (_m *CartData2) CheckMember(userid int, communityid int) (int, string, error) {
...
func (_m *CartData2) CheckStock(_a0 []int) ([]int, string, error) {
	ret := _m.Called(_a0)
...
func (_m *CartData2) DeleteCart(core cart.CoreHistory) (string, error) {
	ret := _m.Called(core)
...
func (_m *CartData2) DeleteFromCart(userid int, cartid int) (string, error) {
...
func (_m *CartData2) GetCommunity(communityid int) (cart.CoreCommunity, string, error) {
...
func (_m *CartData2) GetTotalTransaction(trasacid int) (int, string, error) {
...
func (_m *CartData2) GetUserRole(Userid int, communityid int) (string, error) {
	ret := _m.Called(Userid, communityid)
...
func (_m *CartData2) InsertIntoCart(userid int, productid int) (string, error) {
...
func (_m *CartData2) InsertIntoTransaction(core cart.CoreHistory) (int, string, error) {
	ret := _m.Called(core)
...
func (_m *CartData2) ListHistoryProduct(communityid int) ([]cart.CoreProductResponse, string, error) {
	ret := _m.Called(communityid)
...
func (_m *CartData2) SelectCartList(userid int, communityid int) ([]cart.CoreCart, string, error) {
	ret := _m.Called(userid, communityid)
...
func (_m *CartData2) SelectCommunity(communityid int) (cart.CoreCommunity, string, error) {
	ret := _m.Called(communityid)
...
func (_m *CartData2) UpdateHistory(core cart.CoreHistory, userid int) (string, error) {
...
func (_m *CartData2) UpdateStock(_a0 []int) (string, error) {
	ret := _m.Called(_a0)
...
type mockConstructorTestingTNewCartData2 interface {
	mock.TestingT
	Cleanup(func())
}

// NewCartData2 creates a new instance of CartData2. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewCartData2(t mockConstructorTestingTNewCartData2) *CartData2 {
	mock := &CartData2{}
	mock.Mock.Test(t)
